...
# Localização do arquivo de cookies do Chrome (perfil Default - revisa.precatorio@gmail.com)
...
def extract_cookies():
    ...
    try:
        ...
        if len(all_cookies) == 0:
            ...
            print("")
            print("SOLUÇÃO:")
            print("  1. Abra Chrome (perfil Default - revisa.precatorio@gmail.com)")
...
if __name__ == "__main__":
    ...
    print("  1. Ler cookies do perfil Default do Chrome (revisa.precatorio@gmail.com)")
